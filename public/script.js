document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    ua: {
        ...
        hero_lead: "ЕЛІТНА СІМ'Я НА STAKE RP. ДОМІНУВАННЯ. СТИЛЬ. ДИСЦИПЛІНА.",
        ...
        news_title: "СТРІЧКА", news_title_span: "НОВИН", ph_news_title: "Заголовок", ph_news_text: "Текст новини...", btn_publish: "ПУБЛІКУВАТИ",
    ...
    en: {
        ...
        hero_lead: "ELITE FAMILY ON STAKE RP. DOMINANCE. STYLE. DISCIPLINE.",
    ...
    ru: {
        ...
        hero_lead: "ЭЛИТНАЯ СЕМЬЯ НА STAKE RP. ДОМИНИРОВАНИЕ. СТИЛЬ. ДИСЦИПЛИНА.",
